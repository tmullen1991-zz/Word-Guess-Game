...
function getImage() {
  if (wordUsed === characters[0]) {
    document.getElementById("getImageDisplay").src =
  ...
  if (wordUsed === characters[3]) {
    document.getElementById("getImageDisplay").src = "assets/images/Sam.jpg";
    audio = new Audio("assets/audio/journey.wav");
    audio.play();
  }
  if (wordUsed === characters[4]) {
    document.getElementById("getImageDisplay").src =
      "assets/images/Merry&pippin.jpg";
    audio = new Audio("assets/audio/imhungry.wav");
    audio.play();
  }
  if (wordUsed === characters[5]) {
    document.getElementById("getImageDisplay").src = "assets/images/Gimli.Jpg";
